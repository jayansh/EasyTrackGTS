...
<html lang="en">
  <head>
    ...
    <title>Group Detail Report|Easy Track GTS</title>
...
<h5>Group Detail</h5>
<label>Event Detail(by Group)</label>
<input onclick="document.getElementById('speed').disabled = true; check()" type="radio" id="eventdetail" name="groupdetail">
  <label>Speed over</label>
<input onclick="document.getElementById('speed').disabled = false;  uncheck()" type="radio"  id="speedover"  value="Speed Over" name="groupdetail"/>
  <select id="speed" class="form-control input-lg" style="margin-top: 5px;">
...
<label style=" margin-top: 5px">Format </label>
<select class="form-control input-lg" >
     <option>HTML</option>
     <option>CSV</option>
     <option>XML</option>
